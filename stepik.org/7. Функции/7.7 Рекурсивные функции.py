...
Если записать условие выхода return 0, то результат будет 0, потому что сколько бы значений n в стеке не было, первый множитель, который возвращается при достижении условия выхода из рекурсии будет 0, умножив на который любое число будет равно 0:
